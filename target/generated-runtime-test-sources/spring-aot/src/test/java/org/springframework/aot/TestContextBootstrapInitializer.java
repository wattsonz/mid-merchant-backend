...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.midmerchant.midmerchantbackend.MidMerchantBackendApplicationTests", () -> new AotSpringBootConfigContextLoader(MidMerchantBackendApplicationTestsContextInitializer.class, WebApplicationType.SERVLET, SpringBootTest.WebEnvironment.MOCK));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.midmerchant.midmerchantbackend.MidMerchantBackendApplicationTests", MidMerchantBackendApplicationTestsContextInitializer.class);
    return entries;
  }
}
